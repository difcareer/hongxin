...
"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "ui.router"), function (a, b, c) {
    ...
    function q(a, e, f) {
        ...
        function q(a, e, g, m, n, o, p) {
            ...
            return s.locals = {resolve: null, globals: {$stateParams: {}}}, t = {
                params: {},
                current: s.self,
                $current: s,
                transition: null
    ...
    function s(a, c, d, e, f) {
        var g = e.has("$animator") ? e.get("$animator") : !1, h = !1, i = {
            restrict: "ECA",
            terminal: !0,
            priority: 1e3,
            transclude: !0,
    ...
    function v(a, b) {
        return {
            restrict: "A", require: "?^uiSrefActive", link: function (c, d, e, f) {
    ...
    function w(a, b, c) {
        return {
            restrict: "A", controller: function (d, e, f) {
                function g() {
